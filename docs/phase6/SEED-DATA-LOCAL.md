# 🎯 SEED DATA LOCAL - Dados Realistas SendCraft

## 🗄️ **SISTEMA DE DADOS SEED PARA DESENVOLVIMENTO**

### **Criar `sendcraft/cli/seed_data.py` (NOVO):**
```python
"""
...
# Registrar comando no CLI
def register_seed_command(app):
    """Registra comando seed no Flask CLI"""
    app.cli.add_command(seed_local_data)
```

### **Adicionar ao `sendcraft/cli/__init__.py`:**
```python
"""
SendCraft CLI Commands
"""
from .seed_data import seed_local_data as seed_local_data_command
